/**
 * AdOverlay — full-screen ad creative. Shows the backend-served `mediaUrl`
 * (IMAGE type) with a "REKLAMË" label and a skip control driven by the
 * creative's `skippable` + `skipAfterSeconds` fields. When not skippable the
 * overlay auto-dismisses after `durationSeconds`. `onComplete` fires on either
 * path and is the single dismissal callback.
 */
